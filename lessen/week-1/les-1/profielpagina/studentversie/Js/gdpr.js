        /*gewoon debugger bij een regel neerzetten als je wilt debuggen*/
class GDPR {
    ...
    */
    cookieStatus(status) {
        ...
        const metaData = 
        {
            ...
            tijd : `${date.getHours()}:${(date.getMinutes()< 10 ? '0' : '' )+ date.getMinutes()}`
        }
        localStorage.setItem("gdrp-consent-metadata", JSON.stringify(metaData));
